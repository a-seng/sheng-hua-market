package com.tian.asenghuamarket.redis;
...
public class RedisCache {
    ...
    public Long luaDecrement(final String key) {
        DefaultRedisScript<Long> redisScript = new DefaultRedisScript<>(buildLuaDecrScript(), Long.class);
     ...
     * @param <T>
     */
    public <T> void setCacheObject(final String key, final T vlue, final Integer timeout, final TimeUnit timeUnit) {
        redisTemplate.opsForValue().set(key, vlue, timeout, timeUnit);
    }
